  ...
  return (
    <div className="h-[90vh] flex items-center">
      <div className=" p-2 w-[80%] mx-auto flex flex-col">
        ...
        <div>
          <h3 className="font-bold text-2xl">Ürün Gruplarımız</h3>
          <div className="product-cards flex flex-wrap">
            <div className="card w-[25%] h-[300px] relative border-2 text-center">
              <img src={aydinlatma} className="w-full h-full" alt="" />
              <p className="absolute bottom-5 text-2xl font-bold text-center w-full backdrop-blur-md text-white">
                AYDINLATMA
              </p>
            </div>
            <div className="card w-[25%] h-[300px] relative border-2 text-center">
            ...
            <div className="card w-[25%] h-[300px] relative border-2 text-center">
              ...
              <p className="absolute bottom-5 text-2xl font-bold text-center w-full backdrop-blur-md">
                KAPORTA
              </p>
            </div>
            <div className="card w-[25%] h-[300px] relative border-2 text-center">
